 ...
 * 
 */
package gl.linpeng.analyzer.cfg;
...
public class DefaultConfig implements Configuration {
	...
	public String getFoodDictionary() {
		return PATH_DICT_FOOD;
	}

	@Override
	public String getAdverbDictionary() {
		return PATH_DICT_ADVERB;
	}

	@Override
	public String getNatrientDictionary() {
		return PATH_DICT_NATRIENT;
	}
