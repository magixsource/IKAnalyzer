 ...
 * 
 */
package gl.linpeng.analyzer.core;
...
import gl.linpeng.analyzer.dic.Dictionary;
	...
	Lexeme getNextLexeme() {
		...
		while (result != null) {
			...
			if (Dictionary.getSingleton().isStopWord(this.segmentBuff, result.getBegin(), result.getLength())) {
				...
				if (Dictionary.getSingleton().matchInMainDict(segmentBuff, result.getBegin(), result.getLength())
						.isMatch()) {
					String text = String.valueOf(segmentBuff, result.getBegin(), result.getLength());
					result.setLexemeType(Lexeme.TYPE_DISEASE);
					result.setLexemeText(text);
				} else if (Dictionary.getSingleton()
						.matchInAdverbDict(segmentBuff, result.getBegin(), result.getLength()).isMatch()) {
					result.setLexemeType(Lexeme.TYPE_ADVERB);
					result.setLexemeText(String.valueOf(segmentBuff, result.getBegin(), result.getLength()));
				} else if (Dictionary.getSingleton().matchInFoodDict(segmentBuff, result.getBegin(), result.getLength())
						.isMatch()) {
					result.setLexemeType(Lexeme.TYPE_FOOD);
					result.setLexemeText(String.valueOf(segmentBuff, result.getBegin(), result.getLength()));
				} else if (Dictionary.getSingleton()
						.matchInNatrientDict(segmentBuff, result.getBegin(), result.getLength()).isMatch()) {
					result.setLexemeType(Lexeme.TYPE_NATRIENT);
					result.setLexemeText(String.valueOf(segmentBuff, result.getBegin(), result.getLength()));
				}
				break;
			}
